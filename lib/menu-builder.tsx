    ...
    },
    {
        ...
        subMenu: [
            ...
            },
            {
                ...
                requiredFeature: 'stock-transfer.view',
                allowedRoles: ['business_admin'],
            },
            {
                label: 'Bulk Upload',
                ...
                requiredFeature: 'products.bulk-upload',
            },
            {
    ...
    },
    {
        ...
        subMenu: [
            ...
            // Fiscal Compliance — Professional+ only (advanced group).
            {
                ...
                subMenu: [{ label: 'lbl_compliance_center', href: '/fiscal-compliance', requiredPermissions: ['fiscal.compliance.view'], requiredFeature: 'fiscal.compliance.view' }],
            },
        ],
    },
    {
