        ...
        subMenu: [
            // Sales & Revenue Reports
            {
                ...
                subMenu: [
                    ...
                    { label: 'Employee Sales', href: '/reports/employee-sales', requiredPermissions: ['reports.operations.employee-sales'] },
            ...
            // Customer Reports
            {
                ...
                requiredPermissions: ['reports.sales'],
                subMenu: [
                    { label: 'Customer Report', href: '/reports/customer', requiredPermissions: ['reports.customer'] },
                    { label: 'Customer Due', href: '/reports/customer-due', requiredPermissions: ['reports.customer-due'] },
                    { label: 'Customer Statement', href: '/reports/customer-statement', requiredPermissions: ['reports.operations.customer-statement'] },
                ],
            },
            ...
            // Inventory Reports
            {
                ...
                subMenu: [
                    ...
                    { label: 'Threshold Intelligence', href: '/reports/threshold-intelligence', requiredPermissions: ['reports.threshold-intelligence'] },
            ...
            // Financial Reports
            {
                ...
                subMenu: [
                    ...
                    { label: 'Cash Closing Report', href: '/reports/cash-closing', requiredPermissions: ['reports.operations.cash-closing'] },
                    { label: 'Audit Activity', href: '/reports/audit-activity', requiredPermissions: ['reports.operations.audit-activity'] },
                ],
            },
            // AI Insights
            {
                ...
                requiredPermissions: ['reports.sales'],
                subMenu: [
                    { label: 'Reorder Suggestions', href: '/reports/reorder-suggestions', requiredPermissions: ['reports.reorder-suggestions'] },
                    { label: 'Anomaly Detection', href: '/reports/anomalies', requiredPermissions: ['reports.anomalies'] },
                    { label: 'Demand Forecast', href: '/reports/demand-forecast', requiredPermissions: ['reports.demand-forecast'] },
                    { label: 'Smart Summary', href: '/reports/smart-summary', requiredPermissions: ['reports.summary'] },
                ],
            },
        ],
    },
