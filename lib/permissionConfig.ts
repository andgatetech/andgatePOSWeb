...
export const PERMISSION_MENU_MAP: Record<string, string[]> = {
    ...
    'orders.index': ['Order List', 'Order Returns List', 'Ecommerce Management', 'Store Ecommerce Status', 'Ecommerce Orders', 'Ecommerce Customers', 'Ecommerce Products', 'Ecommerce Settings', 'Courier Credentials'],
    ...
    'hr.payroll.manage': [],
    'hr.advance.view': ['Salary Advance'],
    'hr.advance.create': [],
    'hr.advance.approve': [],
    'hr.bonus.view': ['Festival Bonus'],
    'hr.bonus.manage': [],
    'hr.leave.view': ['Leave Management'],
    'hr.leave.create': [],
    'hr.leave.approve': [],
    'hr.holiday.view': ['Leave Management'],
    'hr.holiday.manage': [],
    'hr.shift.view': ['Shift Scheduling'],
    'hr.shift.manage': [],
    'hr.documents.view': ['Employee Documents'],
    'hr.documents.manage': [],
    'stock-transfer.view': ['Product', 'Stock Transfers'],
    'stock-transfer.manage': ['Product', 'Stock Transfers'],
...
export const ACTION_LABELS: Record<string, string> = {
    ...
    'advance.view': 'View Salary Advances',
    'advance.create': 'Request Salary Advance',
    'advance.approve': 'Approve Salary Advance',
    'bonus.view': 'View Festival Bonus',
    'bonus.manage': 'Manage Festival Bonus',
