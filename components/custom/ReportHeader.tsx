...
import { startOfToday, startOfYesterday, startOfWeek, endOfWeek, startOfMonth, endOfMonth, subDays, subMonths, startOfYear, endOfYear } from 'date-fns';
...
const ReportHeader = ({ title = 'Report', subtitle = '', showStoreSelector = false, selectedStoreId = null, onStoreChange = null }: ReportHeaderProps) => {
    ...
    const displayStore = stores.find((s) => (selectedStoreId ? s.id.toString() === selectedStoreId.toString() : true)) || stores[0];
    ...
    if (!displayStore) {
        return <div className="border-b border-gray-200 bg-white p-6 text-center text-gray-500">No stores found.</div>;
    }
    ...
    return (
        <div className="border-b border-gray-200 bg-white shadow-sm">
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                {/* Report Title and Store Selector */}
                <div className="flex items-end justify-between border-t border-gray-200 pt-4">
                    ...
                    {showStoreSelector && stores.length > 1 && (
                        <div className="ml-4">
                            <label className="mb-1 block text-sm font-medium text-gray-700">Select Store:</label>
                            <select
