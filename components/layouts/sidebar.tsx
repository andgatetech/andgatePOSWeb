...
const Sidebar = () => {
    ...
    return (
        <nav className={`sidebar fixed bottom-0 top-0 z-[90] flex h-full min-h-screen w-[260px] flex-col bg-[#034d79] border-r border-white/[0.07] transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0 lg:-translate-x-full' : '-translate-x-full lg:translate-x-0'}`}>
