...
const IdleProductFilter: React.FC<IdleProductFilterProps> = ({ onFilterChange }) => {
    ...
    const customFilters = (
        <>
            ...
            <div className="relative">
                ...
                >
                    <option value={5}>5 {t('lbl_days_idle')}</option>
                    <option value={10}>10 {t('lbl_days_idle')}</option>
                    <option value={15}>15 {t('lbl_days_idle')}</option>
                    <option value={30}>30 {t('lbl_days_idle')}</option>
                    <option value={180}>180 {t('lbl_days_idle')}</option>
                </select>
    ...
    return (
        <UniversalFilter
            ...
            placeholder={t('placeholder_search_idle_products')}
