...
import { Check, Loader2, Minus, Rocket, Shield, Star, TrendingUp, Zap } from 'lucide-react';
...
const colorClasses = {
    slate:  { ring: 'ring-2 ring-[#046ca9]', button: 'bg-gradient-to-r from-[#046ca9] to-[#034d79] text-white hover:opacity-90', badge: 'bg-[#046ca9]/10 text-[#046ca9]', icon: 'bg-[#046ca9]/10 text-[#046ca9]' },
    green:  { ring: 'ring-2 ring-[#046ca9]', button: 'bg-gradient-to-r from-[#046ca9] to-[#034d79] text-white hover:opacity-90', badge: 'bg-[#046ca9]/10 text-[#046ca9]', icon: 'bg-[#046ca9]/10 text-[#046ca9]' },
    blue:   { ring: 'ring-2 ring-[#046ca9]', button: 'bg-gradient-to-r from-[#046ca9] to-[#034d79] text-white hover:opacity-90', badge: 'bg-[#046ca9]/10 text-[#046ca9]', icon: 'bg-[#046ca9]/10 text-[#046ca9]' },
    purple: { ring: 'ring-2 ring-[#046ca9]', button: 'bg-gradient-to-r from-[#046ca9] to-[#034d79] text-white hover:opacity-90', badge: 'bg-[#046ca9]/10 text-[#046ca9]', icon: 'bg-[#046ca9]/10 text-[#046ca9]' },
    orange: { ring: 'ring-2 ring-[#e79237]', button: 'bg-gradient-to-r from-[#e79237] to-[#c47920] text-white hover:opacity-90', badge: 'bg-[#e79237]/10 text-[#e79237]', icon: 'bg-[#e79237]/10 text-[#e79237]' },
};
                    ...
                    {plans.map((plan, index) => {
                        ...
                        return (
                            <div
                                key={plan.id}
                                className={cn(
                                    'relative flex flex-col overflow-hidden rounded-2xl bg-white transition-all duration-200 hover:-translate-y-1 hover:shadow-xl',
                                    isMostPopular ? 'shadow-xl ' + colors.ring : 'shadow-sm ring-1 ring-gray-100 hover:ring-gray-200'
                                )}
                            >
                                {/* Coloured top accent */}
                                <div className={cn(
                                    'h-1.5 w-full',
                                    colorKey === 'orange'
                                        ? 'bg-gradient-to-r from-[#e79237] to-[#c47920]'
                                        : 'bg-gradient-to-r from-[#046ca9] to-[#034d79]'
                                )} />

                                {isMostPopular && (
                                    <div className="absolute right-3 top-4">
                                        <span className="rounded-full bg-gradient-to-r from-[#046ca9] to-[#034d79] px-2.5 py-0.5 text-[10px] font-bold text-white shadow">
                                            {t('pricing_page.most_popular') || 'Popular'}
                                        </span>
                                    </div>
                                )}
                                ...
                                <div className="flex flex-1 flex-col p-5">
                                    ...
                                    <div className="mb-4 flex items-center gap-2.5">
                                        <div className={cn('flex-shrink-0 rounded-lg p-2', colors.icon)}>
                                    ...
                                    <div className="mb-4 border-b border-gray-50 pb-4">
                                        {hasDiscount && (
                                            <span className="mb-1 inline-block rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-bold text-red-600">
                                                {convertNumberByLanguage(discountPct.toString())}% OFF
                                            </span>
                                        )}
                                    ...
                                    <button
                                        ...
                                        className={cn('mb-4 w-full rounded-xl px-3 py-2.5 text-center text-xs font-bold shadow-sm transition-all duration-200', colors.button)}
                                    >
                ...
                <div className="mt-16">
                    ...
                    <div className="mb-10 text-center">
                        ...
                        <h2 className="mt-3 text-2xl font-black text-gray-900 sm:text-3xl">
                            {t('pricing_page.comparison.subtitle')}
                        </h2>
                        <p className="mt-2 text-sm text-gray-500">
                            {t('pricing_page.comparison.subtitle_detail')}
                        </p>
                    </div>
                        ...
                        <table className="w-full min-w-[640px] border-collapse">
                            ...
                            <thead>
                                <tr className="border-b-2 border-gray-100">
                                    ...
                                    <th className="sticky left-0 z-20 min-w-[200px] bg-[#f8fafc] px-6 py-5 text-left">
                                        <span className="text-xs font-bold uppercase tracking-widest text-gray-400">
                                            {t('pricing_page.comparison.features')}
                                        </span>
                                    </th>
                                    ...
                                    {plans.map((plan, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {isMostPopular && (
                                                    <div className="absolute inset-x-0 top-0 h-1 rounded-t-none bg-gradient-to-r from-[#5bb8e8] to-[#046ca9]" />
                                                )}
                                                <div className="flex flex-col items-center gap-2">
                                                    {isMostPopular && (
                                                        <span className="rounded-full bg-white/20 px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-wide text-white">
                                                            {t('pricing_page.most_popular')}
                                                        </span>
                                                    )}
                                                    <p className={cn('text-sm font-bold', isMostPopular ? 'text-white' : 'text-gray-800')}>
                                                        {lang === 'bn' ? plan.name_bn : plan.name_en}
                                                    </p>
                                                    ...
                                                    <a
                                                        href="/register"
                                                        className={cn(
                                                            'mt-1 rounded-lg px-4 py-1.5 text-[11px] font-bold transition-all',
                                                            isMostPopular
                                        ...
                                        return (
                                            ...
                                            >
                                                <a
                                                    href="/register"
                                                    className={cn(
                                                        'inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-xs font-bold shadow-sm transition-all',
                                                        isMostPopular
