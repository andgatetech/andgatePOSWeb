...
import CashPaymentSection from '@/app/(defaults)/(apps)/pos/pos-right-side/CashPaymentSection';
import CustomerSection from '@/app/(defaults)/(apps)/pos/pos-right-side/CustomerSection';
import LoadingOverlay from '@/app/(defaults)/(apps)/pos/pos-right-side/LoadingOverlay';
import OrderDetailsSection from '@/app/(defaults)/(apps)/pos/pos-right-side/OrderDetailsSection';
import PaymentSummarySection from '@/app/(defaults)/(apps)/pos/pos-right-side/PaymentSummarySection';
import PreviewModal from '@/app/(defaults)/(apps)/pos/pos-right-side/PreviewModal';
import type { Customer, CustomerApiResponse, PosFormData } from '@/app/(defaults)/(apps)/pos/pos-right-side/types';
import { MEMBERSHIP_DISCOUNTS } from '@/app/(defaults)/(apps)/pos/pos-right-side/types';
