...
export default function HomePageClient() {
    ...
    return (
        <MainLayout>
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <h1 className="mb-8 text-5xl font-black leading-[1.2] text-gray-900 md:text-7xl">
                            <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent">{t('hero_title')}</span>
                        </h1>
            ...
            {/* Price Section — plans fetched client-side via RTK Query */}
