...
export default function TrainingPage() {
    ...
    const modules = [
        // ── 01: Account Access ───────────────────────────────────────
        {
            num: '01',
            id: 'account-access',
            title: t('training.category_account_access'),
            desc: t('training.category_account_access_desc'),
            ...
            lessons: [
                {
                    title: t('training.video_create_account'),
                    duration: '4:30',
                    youtubeId: vid(0),
                    difficulty: 'Beginner',
                    desc: t('training.video_create_account_desc'),
                    points: [t('training.kp_createaccount_1'), t('training.kp_createaccount_2'), t('training.kp_createaccount_3')],
                },
                {
                    title: t('training.video_own_login'),
                    duration: '3:45',
                    youtubeId: vid(1),
                    difficulty: 'Beginner',
                    desc: t('training.video_own_login_desc'),
                    points: [t('training.kp_ownlogin_1'), t('training.kp_ownlogin_2'), t('training.kp_ownlogin_3')],
                },
                {
                    title: t('training.video_demo_account'),
                    duration: '3:30',
                    youtubeId: vid(2),
                    difficulty: 'Beginner',
                    desc: t('training.video_demo_account_desc'),
                    points: [t('training.kp_demoaccount_1'), t('training.kp_demoaccount_2'), t('training.kp_demoaccount_3')],
                },
                {
                    title: t('training.video_first_checklist'),
                    duration: '4:15',
                    youtubeId: vid(0),
                    difficulty: 'Beginner',
                    desc: t('training.video_first_checklist_desc'),
                    points: [t('training.kp_firstchecklist_1'), t('training.kp_firstchecklist_2'), t('training.kp_firstchecklist_3')],
                },
            ],
        },
        {
        ...
        // ── 02: Store Configuration ──────────────────────────────────
        {
            ...
            lessons: [
                ...
                {
                    title: t('training.video_cash_drawer_history'),
                    duration: '3:45',
                    youtubeId: vid(0),
                    difficulty: 'Beginner',
                    desc: t('training.video_cash_drawer_history_desc'),
                    points: [t('training.kp_cashdrawerhistory_1'), t('training.kp_cashdrawerhistory_2'), t('training.kp_cashdrawerhistory_3')],
                },
                {
                    title: t('training.video_payroll'),
                    duration: '5:30',
                    youtubeId: vid(0),
                    difficulty: 'Intermediate',
                    desc: t('training.video_payroll_desc'),
                    points: [t('training.kp_payroll_1'), t('training.kp_payroll_2'), t('training.kp_payroll_3')],
                },
                {
                    title: t('training.video_salary_advance'),
                    duration: '4:15',
                    youtubeId: vid(1),
                    difficulty: 'Intermediate',
                    desc: t('training.video_salary_advance_desc'),
                    points: [t('training.kp_salaryadvance_1'), t('training.kp_salaryadvance_2'), t('training.kp_salaryadvance_3')],
                },
                {
                    title: t('training.video_festival_bonus'),
                    duration: '4:00',
                    youtubeId: vid(2),
                    difficulty: 'Intermediate',
                    desc: t('training.video_festival_bonus_desc'),
                    points: [t('training.kp_festivalbonus_1'), t('training.kp_festivalbonus_2'), t('training.kp_festivalbonus_3')],
                },
                {
                    title: t('training.video_leave_shift'),
                    duration: '5:00',
                    youtubeId: vid(0),
                    difficulty: 'Intermediate',
                    desc: t('training.video_leave_shift_desc'),
                    points: [t('training.kp_leaveshift_1'), t('training.kp_leaveshift_2'), t('training.kp_leaveshift_3')],
                },
                {
        ...
        // ── 07: Expenses & Accounting ────────────────────────────────
        {
            ...
            lessons: [
                ...
                {
                    title: t('training.video_bank_cashbook'),
                    duration: '5:00',
                    youtubeId: vid(0),
                    difficulty: 'Intermediate',
                    desc: t('training.video_bank_cashbook_desc'),
                    points: [t('training.kp_bankcashbook_1'), t('training.kp_bankcashbook_2'), t('training.kp_bankcashbook_3')],
                },
                {
                    title: t('training.video_balance_sheet'),
                    duration: '5:30',
                    youtubeId: vid(1),
                    difficulty: 'Advanced',
                    desc: t('training.video_balance_sheet_desc'),
                    points: [t('training.kp_balancesheet_1'), t('training.kp_balancesheet_2'), t('training.kp_balancesheet_3')],
                },
            ],
        },
        // ── 08: Reports & Analytics ──────────────────────────────────
        {
            ...
            lessons: [
                ...
                {
                    title: t('training.video_analytics_bi'),
                    duration: '5:30',
                    youtubeId: vid(0),
                    difficulty: 'Advanced',
                    desc: t('training.video_analytics_bi_desc'),
                    points: [t('training.kp_analyticsbi_1'), t('training.kp_analyticsbi_2'), t('training.kp_analyticsbi_3')],
                },
                {
                    title: t('training.video_fiscal_compliance'),
                    duration: '4:45',
                    youtubeId: vid(0),
                    difficulty: 'Advanced',
                    desc: t('training.video_fiscal_compliance_desc'),
                    points: [t('training.kp_fiscalcompliance_1'), t('training.kp_fiscalcompliance_2'), t('training.kp_fiscalcompliance_3')],
                },
                {
                    title: t('training.video_ai_insights'),
                    duration: '5:15',
                    youtubeId: vid(1),
                    difficulty: 'Advanced',
                    desc: t('training.video_ai_insights_desc'),
                    points: [t('training.kp_aiinsights_1'), t('training.kp_aiinsights_2'), t('training.kp_aiinsights_3')],
                },
                {
                    title: t('training.video_operations_reports'),
                    duration: '4:45',
                    youtubeId: vid(2),
                    difficulty: 'Intermediate',
                    desc: t('training.video_operations_reports_desc'),
                    points: [t('training.kp_opsreports_1'), t('training.kp_opsreports_2'), t('training.kp_opsreports_3')],
                },
            ],
        },
        ...
        // ── 10: Online Store ─────────────────────────────────────────
        {
            ...
            lessons: [
                ...
                {
                    title: t('training.video_cod_reconciliation'),
                    duration: '4:45',
                    youtubeId: vid(1),
                    difficulty: 'Intermediate',
                    desc: t('training.video_cod_reconciliation_desc'),
                    points: [t('training.kp_codrecon_1'), t('training.kp_codrecon_2'), t('training.kp_codrecon_3')],
                },
                {
                    title: t('training.video_marketing_pixel'),
                    duration: '4:00',
                    youtubeId: vid(2),
                    difficulty: 'Intermediate',
                    desc: t('training.video_marketing_pixel_desc'),
                    points: [t('training.kp_marketingpixel_1'), t('training.kp_marketingpixel_2'), t('training.kp_marketingpixel_3')],
                },
            ],
        },
        ...
        },
        {
            num: '14',
            id: 'administration',
            title: t('training.category_administration'),
            desc: t('training.category_administration_desc'),
            ...
            lessons: [
                {
                    title: t('training.video_audit_logs'),
                    duration: '4:30',
                    youtubeId: vid(0),
                    difficulty: 'Advanced',
                    desc: t('training.video_audit_logs_desc'),
                    points: [t('training.kp_auditlogs_1'), t('training.kp_auditlogs_2'), t('training.kp_auditlogs_3')],
                },
                {
                    title: t('training.video_company_branches'),
                    duration: '4:45',
                    youtubeId: vid(1),
                    difficulty: 'Intermediate',
                    desc: t('training.video_company_branches_desc'),
                    points: [t('training.kp_companybranches_1'), t('training.kp_companybranches_2'), t('training.kp_companybranches_3')],
                },
                {
                    title: t('training.video_notifications_export'),
                    duration: '5:00',
                    youtubeId: vid(2),
                    difficulty: 'Intermediate',
                    desc: t('training.video_notifications_export_desc'),
                    points: [t('training.kp_notifexport_1'), t('training.kp_notifexport_2'), t('training.kp_notifexport_3')],
                },
            ],
        },
    ];
