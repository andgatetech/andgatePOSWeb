        ...
        // ── 02: Store Configuration ──────────────────────────────────
        {
            ...
            lessons: [
                ...
                },
                {
                    ...
                    youtubeId: vid(0),
                    difficulty: 'Beginner',
                    desc: 'Review drawer sessions, cash movement, variance, opening cash, closing cash, and counter accountability.',
                    points: ['Open and close cash drawer sessions', 'Track cash in/out movement with reasons', 'Review drawer variance before owner approval'],
                },
                {
                    title: 'Payroll, Salary Advance & Bonus',
                    duration: '5:30',
                    youtubeId: vid(0),
                    difficulty: 'Intermediate',
                    desc: 'Manage staff salary cycles, salary advances, festival bonus, deductions, and payroll payment history.',
                ...
                },
                {
                    ...
                    youtubeId: vid(0),
                    difficulty: 'Intermediate',
                    desc: 'Set store shifts, holidays, leave requests, employee files, and HR records for daily team management.',
                    points: ['Plan staff shifts and store holidays', 'Review leave requests and approval status', 'Keep employee documents in one HR workflow'],
                },
                {
        ...
        // ── 08: Reports & Analytics ──────────────────────────────────
        {
            ...
            lessons: [
                ...
                },
                {
                    ...
                    youtubeId: vid(0),
                    difficulty: 'Advanced',
                    desc: 'Use dashboard widgets, custom reports, scheduled reports, branch benchmarking, cash-flow forecast, break-even, and sales TV.',
                    points: ['Customize owner dashboard widgets', 'Schedule reports for regular review', 'Use BI views for branch and cash-flow decisions'],
                },
                {
                    title: 'Fiscal Compliance & VAT Workspace',
                    duration: '4:45',
                    youtubeId: vid(0),
                    difficulty: 'Advanced',
