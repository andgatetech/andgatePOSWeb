        ...
        <div className="flex min-h-screen">
            ...
            <div className="relative hidden flex-col justify-between overflow-hidden bg-[#0a0f1e] p-12 lg:flex lg:w-5/12 xl:w-2/5">
                ...
                <div className="relative">
                    <Link href="/">
                        <Image src={AndGate} alt="AndgateBOS" width={200} height={40} className="h-10 w-auto object-contain brightness-0 invert" unoptimized />
                    </Link>
                </div>
            ...
            <div className="flex flex-1 flex-col justify-center bg-slate-50 px-6 py-12 sm:px-10 lg:px-16">
                <div className="mb-8 flex justify-center lg:hidden">
                    <Link href="/">
                        <Image src={AndGate} alt="AndgateBOS" width={180} height={36} className="h-9 w-auto object-contain" unoptimized />
                    </Link>
                </div>
