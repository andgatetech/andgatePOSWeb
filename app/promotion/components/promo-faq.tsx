...
const faqs = [
    ...
    },
    {
        ...
        a: 'AndgateBOS ক্লাউড সফটওয়্যার, তাই ভালো ইন্টারনেট থাকলে সবচেয়ে ভালো কাজ করে। কিছু ডিভাইসে আগে লোড হওয়া স্ক্রিন দেখা যেতে পারে, কিন্তু নিয়মিত বিলিং ও ডেটা সেভের জন্য ইন্টারনেট রাখা ভালো।',
    },
    {
    ...
    },
    {
        ...
        a: 'হ্যাঁ। স্টার্টার থেকে এন্টারপ্রাইজ — সব পেইড প্ল্যানেই একাধিক শাখা পরিচালনা করা যায় (২টি থেকে সীমাহীন পর্যন্ত, প্ল্যানভেদে)। প্রতিটি শাখার স্টক, বিক্রয় ও কর্মচারীর তথ্য আলাদাভাবে দেখা যায়।',
    },
    {
