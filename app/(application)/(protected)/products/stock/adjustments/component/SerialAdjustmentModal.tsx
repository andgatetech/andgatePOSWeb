                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={addSerialRow} className="flex items-center gap-2 rounded-lg bg-primary px-3 py-2 text-sm text-white hover:bg-primary/90">
                                    ...
                                    {t('stock_adjustment_add_serial')}
                                </button>
                            </div>

                            {serials.length === 0 ? (
                                <div className="rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-8 text-center">
                                    <p className="text-sm text-gray-500">{t('stock_adjustment_add_serial_hint')}</p>
                                </div>
                            ) : (
                                    ...
                                    {serials.map((serial, index) => (
                                        <div key={serial.id} className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                                            ...
                                            <div className="grid gap-3 sm:grid-cols-2">
                                                <div>
                                                    <label className="mb-1 block text-xs font-medium text-gray-700">{t('stock_adjustment_serial_number')} *</label>
                                                    <input
                                                        type="text"
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder={t('stock_adjustment_additional_notes')}
                                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm"
                                                    />
                                                </div>
                                            </div>
