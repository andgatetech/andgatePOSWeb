    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-3 sm:p-4">
            <div className="w-full max-w-lg overflow-hidden rounded-2xl bg-white shadow-2xl">
                {/* Modal Header */}
                <div className="border-b border-gray-200 bg-gradient-to-r from-emerald-600 to-teal-700 px-6 py-5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                {currentStore && (
                                    <div className="mt-1 flex items-center text-sm text-emerald-100">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    <div className="space-y-5">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className={`w-full appearance-none rounded-xl border px-4 py-3 pr-10 text-gray-900 transition-all focus:outline-none focus:ring-2 ${
                                        errors.ledger_id ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-gray-300 focus:border-emerald-500 focus:ring-emerald-200'
                                    }`}
                                >
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 transition-all focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200"
                    ...
                    <div className="mt-6 flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-3 text-sm font-semibold text-white transition-all hover:from-emerald-700 hover:to-teal-700 disabled:opacity-50"
                        >
                            {isLoading ? (
                                <>
