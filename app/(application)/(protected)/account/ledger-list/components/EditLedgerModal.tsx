                ...
                <div className="border-b border-gray-200 bg-gradient-to-r from-orange-500 to-amber-600 px-6 py-5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-white">Edit Ledger</h2>
                                {currentStore && (
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full appearance-none rounded-xl border border-gray-300 bg-white px-4 py-3 pr-10 text-gray-900 transition-all focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-200"
                                >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {LEDGER_TYPES.map((type) => (
                                ...
                                >
                                    <div className={`text-sm font-semibold ${formData.ledger_type === type.value ? 'text-orange-700' : 'text-gray-900'}`}>{type.label}</div>
