    ...
    const row1Cards = [
        {
            ...
            icon: FileText,
            bgGradient: 'bg-gradient-to-br from-primary to-primary/80',   // brand primary
            route: '/reports/sales',
        ...
        },
        {
            ...
            icon: Percent,
            bgGradient: 'bg-gradient-to-br from-success to-success/80',   // brand success
        ...
        },
        {
            ...
            icon: CreditCard,
            bgGradient: 'bg-gradient-to-br from-warning to-warning/80',   // brand warning
            route: '/reports/sales',
            showMinus: true,
        ...
        },
        {
            ...
            icon: ShoppingCart,
            bgGradient: 'bg-gradient-to-br from-secondary to-secondary/80',   // brand secondary
    ...
    const row2Cards = [
        {
            ...
            icon: RefreshCw,
            bgGradient: 'bg-gradient-to-br from-danger to-danger/80',   // brand danger
        ...
        },
        {
            ...
            icon: Wallet,
            bgGradient: 'bg-gradient-to-br from-dark to-dark/80',   // brand dark
            route: '/reports/profit-loss',
        ...
        },
        {
            ...
            icon: Banknote,
            bgGradient: 'bg-gradient-to-br from-black to-black/80',   // brand black
        ...
        },
        {
            ...
            icon: TrendingUp,
            bgGradient: 'bg-gradient-to-br from-info to-info/80',   // brand info
            route: '/reports/profit-loss',
