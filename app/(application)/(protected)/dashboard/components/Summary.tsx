    ...
    const row1Cards = [
        {
            ...
            icon: FileText,
            bgGradient: 'bg-gradient-to-br from-[#2563eb] to-[#1d4ed8]',   // blue  217°
            route: '/reports/sales',
        ...
        },
        {
            ...
            icon: Percent,
            bgGradient: 'bg-gradient-to-br from-[#16a34a] to-[#15803d]',   // green  142°
        ...
        },
        {
            ...
            icon: CreditCard,
            bgGradient: 'bg-gradient-to-br from-[#d97706] to-[#b45309]',   // amber  43°
            route: '/reports/sales',
            showMinus: true,
        ...
        },
        {
            ...
            icon: ShoppingCart,
            bgGradient: 'bg-gradient-to-br from-[#9333ea] to-[#7e22ce]',   // purple  275°
    ...
    const row2Cards = [
        {
            ...
            icon: RefreshCw,
            bgGradient: 'bg-gradient-to-br from-[#db2777] to-[#9d174d]',   // pink  328°
        ...
        },
        {
            ...
            icon: Wallet,
            bgGradient: 'bg-gradient-to-br from-[#0d9488] to-[#0f766e]',   // teal  175°
            route: '/reports/profit-loss',
        ...
        },
        {
            ...
            icon: Banknote,
            bgGradient: 'bg-gradient-to-br from-[#dc2626] to-[#991b1b]',   // red  0°
        ...
        },
        {
            ...
            icon: TrendingUp,
            bgGradient: 'bg-gradient-to-br from-[#4f46e5] to-[#4338ca]',   // indigo  239°
            route: '/reports/profit-loss',
