    ...
    const addToCart = useCallback(
        async (product: any) => {
            ...
            const itemToAdd = {
                ...
                barcode: primaryStock?.barcode || null,
                rate: regularPrice,
                ...
                tax_included: primaryStock?.tax_included === true || currentStore?.prices_include_tax === true,
                unit: productUnit,
    ...
    const handleVariantSelect = useCallback(
        (variant: any, quantity: number, useWholesale: boolean) => {
            ...
            const itemToAdd = {
                ...
                tax_included: variant.tax_included === true || currentStore?.prices_include_tax === true,
                unit: variantUnit,
        ...
        (selectedSerials: any[], warranty: any) => {
            ...
            selectedSerials.forEach((serial, index) => {
                ...
                const itemToAdd = {
                    ...
                    sku: serialStock?.sku || '',
                    barcode: serialStock?.barcode || null,
                    ...
                    tax_included: serialStock.tax_included === true || currentStore?.prices_include_tax === true,
                    unit: serialUnit,
