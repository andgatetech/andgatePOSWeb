...
const PurchaseOrderPreview: React.FC<PurchaseOrderPreviewProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4" onClick={onClose}>
            <div className="max-h-[90vh] w-full max-w-5xl overflow-y-auto rounded-lg bg-white shadow-lg" onClick={(e) => e.stopPropagation()}>
                {/* Header */}
                ...
                <div className="p-6">
                    <div className="panel" ref={previewRef}>
                        ...
                        <div className="mt-6 space-y-1 px-4 text-right">
                            <div className="font-semibold text-black">{currentStore?.store_name || 'AndgateBOS'}</div>
