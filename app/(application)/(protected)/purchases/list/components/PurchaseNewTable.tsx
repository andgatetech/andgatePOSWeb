...
interface PurchaseNewTableProps {
    orders: any[];
    isLoading: boolean;
    pagination: {
        currentPage: number;
...
const PurchaseNewTable: React.FC<PurchaseNewTableProps> = ({
    orders,
    isLoading,
    pagination,
    sorting,
    ...
    return (
        <ReusableTable
            ...
            emptyState={{
                ...
                title: 'No New Purchase Orders',
                description: 'No new purchase orders found. New orders appear here when status is ordered and payment is pending.',
            }}
        />
    );
};

export default PurchaseNewTable;
