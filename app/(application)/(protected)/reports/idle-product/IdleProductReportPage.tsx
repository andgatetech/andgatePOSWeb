...
const IdleProductReportPage = () => {
    ...
    const [getIdleProductReport, { data: reportData, isLoading, isError }] = useGetIdleProductReportMutation();
            ...
            },
            {
                ...
                render: (v: any, r: any) => (
                    <div className="flex flex-col">
                        ...
                        <span className="mt-1 pl-5 text-[10px] text-gray-400">{t('lbl_purchased')}: {r.purchase_date || t('lbl_unknown')}</span>
                    </div>
                ),
            },
            {
