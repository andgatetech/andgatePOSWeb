...
const SupplierDueReportPage = () => {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                key: 'supplier',
                label: 'Supplier',
                render: (value: any) => <span className="text-sm text-gray-700">{value || 'N/A'}</span>,
            },
            {
                key: 'total_amount',
                label: 'Total Amount',
            ...
            },
            {
                ...
                label: 'Due',
                sortable: true,
                render: (value: any) => <span className="font-bold text-red-600">৳{Number(value || 0).toLocaleString()}</span>,
            },
            {
                key: 'status',
                label: 'Status',
                render: (value: any) => {
                    ...
                    else if (status === 'partial') colorClass = 'bg-yellow-100 text-yellow-800';
                    else if (status === 'pending') colorClass = 'bg-red-100 text-red-800';
            ...
            },
            {
                key: 'due_date',
                label: 'Due Date',
                render: (value: any) => (value ? <span className="text-sm text-gray-700">{new Date(value).toLocaleDateString('en-GB')}</span> : <span className="text-xs text-gray-400">Not set</span>),
            },
        ],
        []
    );
    ...
    return (
        <ReportPageLayout
            ...
            description="View outstanding supplier payments"
