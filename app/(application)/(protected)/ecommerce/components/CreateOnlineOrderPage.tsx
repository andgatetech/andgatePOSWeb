                ...
                <div className="flex flex-col gap-4 border-b border-slate-100 px-5 py-5 lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex min-w-0 gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#046ca9] text-white shadow-sm">
                ...
                <div className="space-y-5">
                    ...
                    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <button type="button" onClick={fillAddressFromCustomer} className="text-xs text-[#046ca9] hover:underline">
                    ...
                    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="relative mb-3">
                            ...
                            {searching && <Loader2 className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 animate-spin text-[#046ca9]" />}
                            <input
                                type="text"
                                value={productSearch}
                            ...
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                                {searchResults.map((product) => (
                                    <button
                                        ...
                                        className="group flex flex-col rounded-lg border border-gray-200 bg-white p-3 text-left transition hover:border-[#046ca9]/40 hover:shadow-md"
                                    >
                                        <div className="mb-2 flex items-start justify-between gap-2">
                                            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-gray-50">
                                                <Package className="h-5 w-5 text-gray-300" />
                                            </div>
                                            <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-[#046ca9] text-white opacity-0 transition group-hover:opacity-100">
                                        ...
                                        <div className="mt-2 flex items-center justify-between">
                                            <span className="text-sm font-bold text-[#046ca9]">৳{product.price.toLocaleString()}</span>
                                            <span
                ...
                <aside className="space-y-5">
                    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                        <div className="mb-3 flex items-center gap-2">
                            <ShoppingBag className="h-4 w-4 text-[#046ca9]" />
                        ...
                        <div className="mt-4 space-y-1.5 border-t border-gray-100 pt-3">
                            ...
                            <div className="flex justify-between border-t border-gray-100 pt-2 text-base font-bold">
                                ...
                                <span className="text-[#046ca9]">৳{total.toLocaleString()}</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col gap-2">
                            <button
                                ...
                                disabled={creating}
                                className="flex items-center justify-center gap-2 rounded-lg bg-[#046ca9] px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-50"
                            >
