            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div className="flex gap-3">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-amber-800">{t('ecommerce_service_not_enabled_desc').replace('{store}', getStoreName(store))}</p>
                    </div>
                </div>
                <div className="w-full md:max-w-md">
                    <textarea
                        ...
                        className="w-full rounded-lg border border-amber-200 bg-white px-3 py-2 text-sm text-gray-900 focus:border-[#046ca9] focus:outline-none focus:ring-1 focus:ring-[#046ca9]"
                    />
                    <button
                        type="button"
                        onClick={handleSubmit}
                        disabled={isLoading}
                        className="mt-2 inline-flex items-center gap-2 rounded-lg bg-[#046ca9] px-4 py-2 text-sm font-semibold text-white hover:bg-[#034d79] disabled:cursor-not-allowed disabled:opacity-60"
                    >
