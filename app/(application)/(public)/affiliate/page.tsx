...
export default function AffiliateLandingPage() {
    ...
    const [formData, setFormData] = useState({ name: '', mobile: '', email: '', type: 'other', bkash_number: '', network_description: '' });
    ...
    return (
        <main className="min-h-screen bg-slate-50 text-slate-800">
            ...
            {/* Hero */}
            <section className="bg-gradient-to-br from-primary to-[#034d79] text-white py-20 px-4">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        <button onClick={() => setShowForm(true)} className="rounded-xl bg-yellow-400 text-slate-900 font-bold px-8 py-3 text-lg hover:bg-yellow-300 transition">
                            এখনই রেজিস্ট্রেশন করুন — বিনামূল্যে
                        </button>
                        <a href="#tiers" className="rounded-xl border-2 border-white/60 px-8 py-3 text-lg font-semibold hover:bg-white/10 transition">
                            কমিশন দেখুন ↓
                        </a>
                    </div>
