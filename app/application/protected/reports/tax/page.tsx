            ...
            <div className="mb-4 rounded-xl bg-white p-4 shadow-sm sm:mb-6 sm:rounded-2xl sm:p-5 md:mb-8 md:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-gray-900 sm:text-2xl md:text-3xl">Tax Report</h1>
                            <p className="text-xs text-gray-500 sm:text-sm">Comprehensive tax analysis and insights</p>
                        </div>
                    </div>
