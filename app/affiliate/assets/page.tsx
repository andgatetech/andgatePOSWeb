...
const WHATSAPP_SCRIPTS = [
    {
        ...
        text: 'ভাই, আপনার দোকানে কোন পণ্য কত স্টক আছে, কার কাছে কত বাকি আছে, আর আজ কত বিক্রি হলো — সব একসাথে দেখা গেলে হিসাব রাখা সহজ হয়। AndgateBOS দিয়ে বিলিং, স্টক, বাকি, পেমেন্ট ও রিপোর্ট একসাথে ম্যানেজ করা যায়।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। চাইলে ১৪ দিনের ফ্রি ট্রায়াল দেখাতে পারি।',
    },
    {
        title: 'ফার্মেসি',
        ...
        text: 'ভাই, ফার্মেসিতে স্টক, সেলস রিপোর্ট আর দ্রুত বিলিং ঠিক না থাকলে লাভ-লোকসান বোঝা কঠিন হয়। AndgateBOS দিয়ে পণ্য, স্টক, বিক্রি, কাস্টমার বাকি ও রিপোর্ট একসাথে রাখা যায়।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। চাইলে আপনার দোকানের ধরন অনুযায়ী ডেমো দেখাতে পারি।',
    },
    {
        ...
        text: 'ভাই, কাপড়ের দোকানে সাইজ, কালার, স্টক আর বাকি হিসাব আলাদা খাতায় রাখলে ভুল হওয়ার সুযোগ থাকে। AndgateBOS দিয়ে বিক্রি, স্টক, পেমেন্ট, বাকি ও রিপোর্ট একসাথে দেখা যায়।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। আপনার দোকানে কাজে লাগবে কিনা, আগে ফ্রি ট্রায়ালে দেখে নিতে পারেন।',
    },
    {
        ...
        text: 'ভাই, ইলেকট্রনিক্স/হার্ডওয়্যার দোকানে পণ্যের দাম, স্টক, কাস্টমারের বাকি ও পেমেন্ট ট্র্যাক রাখা খুব জরুরি। AndgateBOS দিয়ে বিলিং, স্টক, রিপোর্ট ও কাস্টমার হিসাব এক জায়গায় রাখা যায়।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। চাইলে ডেমো বুক করে দিতে পারি।',
    },
    {
        ...
        text: 'ভাই, রেস্টুরেন্টে অর্ডার, ক্যাশ, দৈনিক বিক্রি আর রিপোর্ট ঠিকমতো না থাকলে ম্যানেজ করা কঠিন হয়। AndgateBOS দিয়ে বিক্রি, পেমেন্ট, রিপোর্ট এবং অনলাইন অর্ডার একসাথে দেখা যায়।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। চাইলে ১৪ দিনের ফ্রি ট্রায়াল দিয়ে শুরু করা যায়।',
    },
    {
        ...
        text: 'আপনার যেসব দোকানদার ক্লায়েন্ট হিসাব, স্টক বা বিলিং নিয়ে সমস্যায় আছেন, তাদের AndgateBOS দেখাতে পারেন। তারা সফটওয়্যার ব্যবহার করলে আপনার হিসাব/সাপোর্ট কাজও সহজ হবে।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। সফল পেইড সাবস্ক্রিপশন হলে নীতিমালা অনুযায়ী কমিশন প্রযোজ্য।',
    },
];
...
const COMPLIANCE_RULES = [
    {
        ...
        items: [
            'বাস্তব দোকানদারকে AndgateBOS রেফার করলে কমিশন প্রযোজ্য।',
            'কমিশন শুধু সফল পেইড সাবস্ক্রিপশন ও যাচাই শেষে হয়।',
            'আমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি।',
        ],
    },
    {
        icon: XCircle,
...
const POST_TEMPLATES = [
    {
        ...
        text: 'দোকানের বিক্রি, স্টক, বাকি, পেমেন্ট ও রিপোর্ট একসাথে দেখতে চান? AndgateBOS দিয়ে ১৪ দিনের ফ্রি ট্রায়াল শুরু করা যায়।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি। ডেমো দেখতে চাইলে ইনবক্স/WhatsApp করুন।',
    },
    {
        title: 'WhatsApp স্ট্যাটাস',
        text: 'দোকানের স্টক, বাকি আর দৈনিক বিক্রির হিসাব একসাথে রাখতে AndgateBOS ব্যবহার করে দেখতে পারেন। ১৪ দিনের ফ্রি ট্রায়াল আছে।\n\nআমি AndgateBOS অ্যাফিলিয়েট হিসেবে রেফার করছি।',
    },
    {
        title: 'ডেমো ফলোআপ',
...
export default function AffiliateAssetsPage() {
    ...
    const waRequestUrl = (item: string) =>
        `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`আমি AndgateBOS অ্যাফিলিয়েট। অনুগ্রহ করে এই মেটেরিয়ালটি পাঠান: ${item}`)}`;
        ...
        <div className="py-10 px-4">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-primary to-[#034d79] text-white p-6 text-center">
                    ...
                    <button
                        onClick={() => handleCopy('ভাই, AndgateBOS দিয়ে দোকানের বিক্রি, স্টক, বাকি, পেমেন্ট ও রিপোর্ট একসাথে দেখা যায়। আগে ১৪ দিনের ফ্রি ট্রায়ালে নিজের দোকানের কাজ মিলিয়ে দেখতে পারেন।', 'framing')}
